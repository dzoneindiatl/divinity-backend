        ...
        <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col  mb-3">
                                <div class="form-group">
                                    <label for="wash_care">Jewellery Care </label>
            ...
            <div class="accordion" id="productAccordion">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="categorys_id" id="categorys_id" class="form-control" onchange="getsubcategory(this.value);">
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="subcategory_id" id="subcategory_id" class="form-control" onchange="getproduct(this.value);">
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="Product_id[]" id="Productid" class="form-control product_select2" multiple>
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3">
                        <label for="qty">Total Available Stock <span class="text-danger">*</span></label>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col mb-3">
                        <label for="minProduct">Minimum Quantity Alert(For Customers)</label>
                            ...
                            <div class="col-auto m-3">
                                <div class="mb-3">
                                    ...
                                    <input type="file"
                                        ...
                                        accept="image/*"                                             
                                        //onchange="openCropper(event, {{ $product->id }})"
                                        class="form-control cropers-images" multiple>
                                </div>
                                <div class="mb-3">
