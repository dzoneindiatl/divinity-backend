                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <select class="select2-original form-control @error('select_type') is-invalid @enderror styleTypeSelect"
                                ...
                                <option value="">Select Type</option>
                                <option value="1">Sub Category + Child Category with Image</option>
                                <option value="2">Sub Category with Image</option>
                                <option value="3">Sub Category with Icon Image</option>
                                <option value="4">Sub Category Dropdown</option>
                                <option value="5">Without Submenu</option>
                            </select>
                        ...
                        <div class="col-xl-6 mb-3">
                            <label for="thumbnail_image" class="form-label">Thumbnail Image / Icon Image
